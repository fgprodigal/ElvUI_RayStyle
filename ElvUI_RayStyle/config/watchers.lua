...
local positions = {
    player_buff_icon    = { "BOTTOMRIGHT", "ElvUF_Player", "TOPRIGHT", 0, 80 },	-- "玩家buff&debuff"
    target_buff_icon    = { "BOTTOMLEFT", "ElvUF_Target", "TOPLEFT", 0, 80 },	-- "目标buff&debuff"
    player_proc_icon    = { "BOTTOMRIGHT", "ElvUF_Player", "TOPRIGHT", 0, 33 },	-- "玩家重要buff&debuff"
    target_proc_icon    = { "BOTTOMLEFT", "ElvUF_Target", "TOPLEFT", 0, 33 },	-- "目标重要buff&debuff"
    focus_buff_icon     = { "BOTTOMLEFT", "ElvUF_Focus", "TOPLEFT", 0, 10 },	-- "焦点buff&debuff"
    cd_icon             = function() return RS:IsDeveloper() and { "TOPLEFT", "ElvAB_1", "BOTTOMLEFT", 0, -6 } or { "TOPLEFT", "ElvAB_3", "BOTTOMRIGHT", -28, -6 } end,	-- "cd"
    player_special_icon = { "TOPRIGHT", "ElvUF_Player", "BOTTOMRIGHT", 0, -9 }, -- "玩家特殊buff&debuff"
    pve_player_icon     = { "BOTTOM", E.UIParent, "BOTTOM", -35, 350 }, -- "PVE/PVP玩家buff&debuff"
    pve_target_icon     = { "BOTTOM", E.UIParent, "BOTTOM", 35, 350 }, -- "PVE/PVP目标buff&debuff"
}
    ...
    ["filters"] = {
        ["DRUID"] = {
            ...
            },
            {
                ...
                size = 28,
                barWidth = 170,
                direction = function() return RS:IsDeveloper() and "RIGHT" or "DOWN" end,
                mode = function() return RS:IsDeveloper() and "ICON" or "BAR" end,
