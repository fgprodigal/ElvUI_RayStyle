...
function RS:LoadMisc_Quest()
    ...
    function QuickQuest:Register(event, func, override)
        ...
        self[event] = function(...)
            if (override or (not IsShiftKeyDown() and E.db.RS.misc.automation)) then
    ...
    ChatFrame_AddMessageEventFilter("CHAT_MSG_SYSTEM", function(self, event, message)
        if E.db.RS.misc.automation then
...
hooksecurefunc(M, "Initialize", RS.LoadMisc_Quest)