...
function RS:LoadMisc_Announce()
	if not E.db.RS.misc.anounce then return end
	...
	local function CreateMessageFrame(name)
		...
		f:SetMaxLines(3)
		f:FontTemplate(nil, fontsize, fontflag)
...
hooksecurefunc(M, "Initialize", RS.LoadMisc_Announce)